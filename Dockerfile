...
RUN DEBIAN_FRONTEND=noninteractive && apt-get update && \
	apt-get -y upgrade && \
	apt-get install -y apache2 php7 php7-common php7-json php7-opcache php-uploadprogress php-memcache php7.0-zip php7.0-mysql php7.0-phpdbg php7.0-gd php7.0-imap php7.0-ldap php7.0-pgsql php7.0-pspell php7.0-recode php7.0-tidy php7.0-dev php7.0-intl php7.0-curl php7.0-xmlrpc php7.0-xsl php7.0-bz2 php7.0-mbstring pkg-config libmagickwand-dev imagemagick build-essential && \
